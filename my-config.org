...
*** Dired custom maps
    ...
    (define-key l/dired-nav-map (kbd "h") (lambda () (interactive) (dired "~/")))
    (define-key l/dired-nav-map (kbd "D") (lambda () (interactive) (dired "~/Downloads/")))
    (define-key l/dired-nav-map (kbd "d") (lambda () (interactive) (dired "~/Documents/")))
    (define-key l/dired-nav-map (kbd "p") (lambda () (interactive) (dired "~/Pictures/")))
    (define-key l/dired-nav-map (kbd "M") (lambda () (interactive) (dired "~/Music/")))
    (define-key l/dired-nav-map (kbd "v") (lambda () (interactive) (dired "~/Videos/")))
    (define-key l/dired-nav-map (kbd "m") (lambda () (interactive) (dired "/run/media/louk/")))
    (define-key l/dired-nav-map (kbd "C") (lambda () (interactive) (dired "~/.config/")))
    (define-key l/dired-nav-map (kbd "E") (lambda () (interactive) (dired "~/.emacs.d/")))
    (define-key l/dired-nav-map (kbd "!") (lambda () (interactive) (dired "~/dotfiles/")))
    #+end_src
...
**** Peepy-fied dired functions
     ...
     #+begin_src emacs-lisp
     (defun l/peep-dired-up-directory ()
       "Peep first file when moving up directory."
       (interactive)
       (dired-up-directory)
       (peep-dired-display-file-other-window))

     (defun l/peep-dired-find-file ()
     ...
     (defun l/peep-dired-prev-dirline ()
       "Peep previous dirline."
       (interactive)
       (dired-prev-dirline 1)
       (peep-dired-display-file-other-window))

     (defun l/peep-dired-next-dirline ()
       "Peep next dirline."
       (interactive)
...
**** Load Peep
	...
	(use-package peep-dired
	  ...
	  :config
	  ;; unbind SPC and DEL from emacs mode as it messes with Wdired
	  (define-key peep-dired-mode-map (kbd "<backspace>") nil)
	  (define-key peep-dired-mode-map (kbd "SPC") nil)
	  (define-key peep-dired-mode-map (kbd "C-SPC") nil)
	  ;; evil integration
	  (eval-after-load "evil"
	    '(progn
		 ...
		 (kbd "h") 'l/peep-dired-up-directory
		 (kbd "<left>") 'l/peep-dired-up-directory
		 (kbd "l") 'l/peep-dired-find-file
		 (kbd "<right>") 'l/peep-dired-find-file
		 (kbd ">") 'l/peep-dired-next-dirline
		 (kbd "<") 'l/peep-dired-prev-dirline
