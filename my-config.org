...
(use-package dired-ranger
  ...
  (eval-after-load "evil"
    '(progn
       (evil-define-key 'normal dired-mode-map "rc" 'dired-ranger-copy)
       (evil-define-key 'normal dired-mode-map "rm" 'dired-ranger-move)
       (evil-define-key 'normal dired-mode-map "rp" 'dired-ranger-paste))))
#+end_src
