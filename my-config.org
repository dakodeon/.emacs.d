...
*** mu4e bookmarks
    ...
    (defvar l/mu4e-last-received-msg nil
      "Stores the id of the last received message.")
    ...
    (add-hook 'mu4e-index-updated-hook
		...
		(let* ((query (string-trim (format "%s" (mapcar (lambda (x) (concat "maildir:/" x "/Inbox OR ")) l/mu4e-context-names)) "(" " OR )")))
		  (setq l/mu4e-last-received-msg (string-trim (shell-command-to-string (concat "mu find -n 1 --fields \"i\" --sortfield=date --reverse " query)) nil "\n")))))
    ...
    (setq mu4e-bookmarks
	  `( ,(make-mu4e-bookmark
	     ...
	     ,(make-mu4e-bookmark
	       ...
	       :query (concat "msgid:" l/mu4e-last-received-msg)
	       :key ?l)))
    #+end_src
